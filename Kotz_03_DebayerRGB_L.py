...
project_dir = '//nmfs/akc-nmml/Polar_Imagery/Techniques_Test/KAMERA_InFlightSystem_2019/polar_bear_2019/10/LEFT'
...
save_dir = '//nmfs/akc-nmml/Polar_Imagery_2/TempDebayered/Left'
