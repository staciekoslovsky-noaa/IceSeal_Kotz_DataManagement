...
#RPostgreSQL::dbSendQuery(con, "DELETE FROM surv_test_kotz.tbl_detections_processed_ir")

# Import data and process
## PROCESSED DATA
processed_id <- RPostgreSQL::dbGetQuery(con, "SELECT max(id) FROM surv_test_kotz.tbl_detections_processed_ir")
...
# Import data to DB
RPostgreSQL::dbWriteTable(con, c("surv_test_kotz", "tbl_detections_processed_ir"), processed, append = TRUE, row.names = FALSE)
